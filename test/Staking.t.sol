...
contract StakingTest is Test {
    ...
    function testGetStakes() public {
        ...
        Staking.Stake[] memory stakesAlice = staking.getStakes(alice, 0, 100);
        ...
        Staking.Stake[] memory stakesBob = staking.getStakes(bob, 0, 100);
        ...
        Staking.Stake[] memory stakesBob3 = staking.getStakes(bob, 1, 10);
