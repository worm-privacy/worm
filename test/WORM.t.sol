...
contract WORMTest is Test {
    ...
    function test_reward() public {
        worm = new WORM(IERC20(address(0)), address(this), 0);
    ...
    function test_constructor() public {
        ...
        // Test with preMine
        worm = new WORM(IERC20(address(beth)), alice, preMineAmount);
    ...
    function test_epochsWithNonZeroRewards() public {
        ...
        (uint256 till, uint256[] memory result) = worm.epochsWithNonZeroRewards(0, worm.currentEpoch(), alice, 100);
